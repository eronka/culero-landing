    ...
    return (
        <div className="flex flex-col 2xl:space-y-14 lg:space-y-8 space-y-6 md:w-1/2 w-full">
            ...
            <div className="flex flex-col space-y-4 xl:text-[24px] lg:text-[22px] text-[18px] xl:leading-[36px] lg:leading-[30px] leading-[26px] font-meidum w-full">
                ...
                <div className="flex justify-between xl:w-[75%] w-[85%] bg-[#F8F8F8] p-2 rounded-2xl">
                    <div className="flex items-center xl:w-[70%] w-[80%]">
                        <input type="email" className="w-full italic xl:text-[20px] lg:text-[16px] text-[14px] font-medium lg:px-4 px-2 bg-transparent focus:outline-none text-black" placeholder="Enter email address" />
                    </div>
                    <button className="font-semibold xl:text-[22px] lg:text-[18px] text-[15px] bg-[#1E68FF] rounded-2xl py-2 xl:px-8 lg:px-6 px-4">Subscribe</button>
                </div>
            </div>
